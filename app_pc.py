...
class VideoTransformer(VideoTransformerBase):
    def __init__(self):
        ...
        self.threshold1 = 0.5
        self.threshold2 = 0.5
        weightsPath = os.path.sep.join([r"C:\Users\lisat\OneDrive\Documentos\Celepar\workspace\streamlit-docker\src\coco", "yolov4.weights"])
        configPath = os.path.sep.join([r"C:\Users\lisat\OneDrive\Documentos\Celepar\workspace\streamlit-docker\src\coco", "yolov4.cfg"])

        labelsPath = os.path.sep.join([r"C:\Users\lisat\OneDrive\Documentos\Celepar\workspace\streamlit-docker\src\coco", "obj.names"])
...
def setModel(self, model):
    ...
    if (self.model != model):
        ...
        if (model == 'diversos'):
            ...
            weightsPath = os.path.sep.join([r"C:\Users\lisat\OneDrive\Documentos\Celepar\workspace\streamlit-docker\src\gun", "yolov4.weights"])
            configPath = os.path.sep.join([r"C:\Users\lisat\OneDrive\Documentos\Celepar\workspace\streamlit-docker\src\gun", "yolov4.cfg"])
            labelsPath = os.path.sep.join([r"C:\Users\lisat\OneDrive\Documentos\Celepar\workspace\streamlit-docker\src\gun", "obj.names"])
